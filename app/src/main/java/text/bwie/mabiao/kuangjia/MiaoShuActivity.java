...
import text.bwie.mabiao.kuangjia.presenter.VideoPresenter;
import text.bwie.mabiao.kuangjia.utils.SPutils;
import text.bwie.mabiao.kuangjia.view.VideoViews;

public class MiaoShuActivity extends BaseActivity implements View.OnClickListener, VideoViews {

    private LinearLayout mTui;
    private ImageView mHuan;
    private Button mFb;
    ...
    public void initView() {
        mTui = findViewById(R.id.fengmian_tui);
        mHuan = findViewById(R.id.fengmian_huan);
        mFb = findViewById(R.id.fengmian_bt_fb);
        mContent = findViewById(R.id.fengmian_ed_content);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.fengmian_tui:
                finish();
                break;
            case R.id.fengmian_huan:
                // 进入相册 以下是例子：用不到的api可以不写
                PictureSelector.create(MiaoShuActivity.this)
                ...
                break;
            case R.id.fengmian_bt_fb:
                String path = sp.getString("path", null);
                int uid = sp1.getInt("uid", 0);
                videoPresenter.VideoShangChuan(uid+"",mContent.getText().toString().trim(),path,selectList,50+"",40+"");
                break;
        }
    }
    @Override
            ...
            switch (requestCode) {
                case PictureConfig.CHOOSE_REQUEST:
                    ...
                    for (LocalMedia media : selectList) {
                        ...
                        Glide.with(this).load(media.getPath()).into(mHuan);
                    }
                    break;
